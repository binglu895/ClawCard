...
export const Card: React.FC<CardProps> = ({ card, isSelected, onToggleSelect }) => {
  return (
    <div
      ...
      className={`
        w-24 h-36 sm:w-36 sm:h-52 [@media(max-height:500px)]:w-20 [@media(max-height:500px)]:h-32 rounded-lg flex flex-col p-2 sm:p-3 text-background-dark 
        ...
        ${isSelected ? 'transform -translate-y-6 sm:-translate-y-10 [@media(max-height:500px)]:-translate-y-4 border-2 border-primary' : 'hover:-translate-y-4'}
      `}
    >
